...
const FAQS = [
  {
    question: "How can I donate to Real Human Trust?",
    answer:
      "You can securely donate online using UPI, Credit/Debit cards, or Net Banking through our Donate page. We also accept direct bank transfers (NEFT/RTGS/IMPS).",
  },
  {
    question: "Are my donations tax-exempted under 80G?",
    answer:
      "Yes, all donations made to Real Human Education & Charitable Trust are eligible for a 50% tax deduction under Section 80G of the Income Tax Act. You will automatically receive an 80G receipt on your email upon successful donation and verification.",
  },
  {
    question: "Where does the organization operate?",
    answer:
      "We are based in Rajkot, Gujarat, and our primary focus areas include rural regions and underdeveloped communities across Gujarat, focusing on education, healthcare, and women empowerment.",
  },
  {
    question: "How can I volunteer or become a member?",
    answer:
      "We welcome passionate individuals! You can join us by filling out the Volunteer form on our website, or by opting for one of our Membership plans (Basic, Premium, or Lifetime) to actively participate in our core decisions and events.",
  },
  {
    question: "Can I sponsor a specific child's education or a specific campaign?",
    answer:
      "Absolutely. Through our Crowdfunding section, you can choose specific active campaigns to support. If you want to sponsor a child's complete yearly education, please contact us directly via email or phone for tailored sponsorship packages.",
  },
  {
    question: "How do you ensure transparency in fund utilization?",
    answer:
      "Transparency is our core value. We regularly publish Annual Reports and audit statements which are accessible on our website. Every major project's financial breakdown is shared with our donors and lifetime members.",
  },
]
